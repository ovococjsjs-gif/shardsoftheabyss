...
# После разделения прежней гл. 20 нумерация финала сдвинулась на +1.
# Гл. 35 целиком происходит внутри души: речи вслух там нет физически,
# и норма «средняя реплика вслух ≥4» к ней неприменима.
# Гл. 36 — обратный случай: внешняя глава, где Тень держится в тени
# намеренно (Сильвия заново собирает себя среди людей).
NO_SPOKEN = {"ch-35.md"}
FINALE_EXEMPT = {"ch-36.md"}
SILVIA_MIN_AVG = 4.0
